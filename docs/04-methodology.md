...
- **Direction wrapped, and only where defined.** Signed angle wrapped to
  ...
  *direction undefined* rather than dropped. That count is part of the result.
  The threshold is **2.0 m s⁻¹**, swept at 1.0 and 3.0 as a sensitivity table. It was
  fixed in [`adr/0015`](adr/0015-what-makes-the-reanalysis-a-useful-proxy.md) before any
  agreement statistic had been computed.
